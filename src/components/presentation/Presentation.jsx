  ...
  return (
    <>
      ...
      <Container className=" container containerPresentacion" width={100}>
        <Row className="m-0 p-0 rowSobreMi " xl={6} md={6}  height={100}  width={100}>
          <Col xl={6} md={6} sm={12} xs={12} className="colPresentacion">
            <Row>
              <h2 className="miNombre my-4">Martina Soria Lanzi</h2>
            <p className="miCarrera m-0">FullStack Developer</p>
              <p className="miCarrera mt-0">Industrial Engeenier</p>
              <Col>
              <Link to="https://www.linkedin.com/in/martina-soria-lanzi-4004371b8/" target="_blank">
              <svg
               ...
               <Link to="https://github.com/Martinasorialanzi" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          <Col xl={6} md={6} sm={12} xs={12} className="colWomanDev ">
            <Image src={fotoCv} className="womanDevPic img-fluid " roundedCircle alt="imagenCv"></Image>
          </Col>
        </Row>
      </Container>
    </>
